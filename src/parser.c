...
#endif
#define ParseARG_SDECL  ParseState *state ;
#define ParseARG_PDECL , ParseState *state 
#define ParseARG_PARAM ,state 
#define ParseARG_FETCH  ParseState *state =yypParser->state ;
...
#define YY_ERROR_ACTION      2
#define YY_ACCEPT_ACTION     3
#define YY_NO_ACTION         4
...
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     0,   18,   19,   19,   19,   19,   19,   19,   19,   19,
 /*    10 */    19,   19,   19,   19,   19,   19,   19,   19,   19,   18,
};
